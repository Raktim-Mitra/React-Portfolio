...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "f4a2e5f1-1441-41de-82fd-3015c3e94308");
        ...
        <Box flex="1" mr={{ md: 10 }} mb={{ base: 10, md: 0 }}>
          <VStack align="start" spacing={{base:"3",md:"5"}}>
            ...
            <HStack>
              ...
              <Text fontSize="lg">mitraraktim294@gmail.com</Text>
            </HStack>
            <HStack>
          ...
          {!showForm ? (
            ...
            >
              ...
              <Box h="full" display="flex" justifyContent="center" alignItems="center">
                <svg width="300px" height="300px" viewBox="0 0 32.666 32.666" fill="none" stroke='#BB86FC'>
                  <motion.path
                    strokeWidth={0.2}
                    fill="none"
